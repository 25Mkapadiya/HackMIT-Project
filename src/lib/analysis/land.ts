  ...
  return {
    ...
    nearestMajorRoadMiles: bundle.roads
      ...
      : {
          ...
          unit: "mi",
          confidence: "unknown",
          source: noDatasetSource("road-classification"),
    ...
    naturalHazards: {
      ...
      source: {
        id: `curated-${bundle.stateCode.toLowerCase()}-hazards`,
        name: `Curated ${bundle.stateCode} natural hazard assessment`,
        url: "",
      ...
      caveats:
        hazards.length > 0
          ...
          : [`No curated hazard assessment has been entered for ${bundle.stateCode} yet.`],
    },
  };
}

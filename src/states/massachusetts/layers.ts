...
import { MA_SOURCES } from "./sources";

/**
 * Full layer registry for Massachusetts — mirrors src/states/delaware/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const MA_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: MA_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static — see source note). Massachusetts is electrically integrated into the ISO New England bulk-power network.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: MA_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: MA_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: MA_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Connecticut, Merrimack, and Charles River systems.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: MA_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
    description: "USGS National Hydrography Dataset waterbody polygons (small-scale), including the Quabbin and Wachusett Reservoirs.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: MA_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: MA_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: MA_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities — a proxy for interconnection density. Boston is a major northeastern fiber and cloud market.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: MA_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. Coastal Massachusetts, the Boston Harbor region, and the Merrimack/Connecticut River basins are priority areas to check.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: MA_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: MA_SOURCES.usgsShadedRelief,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: MA_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: MA_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. Massachusetts's generation mix includes natural gas, offshore wind, solar, battery storage, and regional nuclear/hydro imports. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: MA_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported Massachusetts data center/colocation clusters. Not exhaustive.",
    defaultVisible: true,
...
export function getMaLayer(id: string): LayerDefinition | undefined {
  return MA_LAYERS.find((l) => l.id === id);
}

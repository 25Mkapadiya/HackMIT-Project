...
/**
 * Canonical source metadata for Tennessee. Mirrors src/states/alabama/sources.ts:
 * TDEC's Water Withdrawal Registration Program tracks withdrawals ≥10,000
 * gal/day but publishes no public point-level GIS layer we could find, and no
...
export const TN_SOURCES = {
  curatedDataCenters: {
    id: "curated-tn-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Tennessee)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Tennessee data center campuses/projects. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

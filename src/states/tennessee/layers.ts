...
import { TN_SOURCES } from "./sources";

/**
 * Full layer registry for Tennessee — mirrors src/states/alabama/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const TN_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: TN_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static — see source note). Tennessee is dominated by Tennessee Valley Authority (TVA) infrastructure, distributed through local power companies like Nashville Electric Service, Memphis Light Gas & Water, and Chattanooga EPB.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: TN_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: TN_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: TN_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Tennessee, Cumberland, Mississippi, Clinch, and Holston River systems.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: TN_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
    description: "USGS National Hydrography Dataset waterbody polygons (small-scale), including TVA's extensive reservoir system.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: TN_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: TN_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: TN_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities — a proxy for interconnection density, not a survey of long-haul fiber routes through Nashville, Memphis, Knoxville, or Chattanooga.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: TN_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. The Mississippi River corridor, Cumberland River basin, and Nashville's flood-prone areas are priority zones to check.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: TN_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
      "Visual forest/wood land-cover polygons from the CARTO basemap's OpenStreetMap-derived landcover layer (e.g. Cherokee National Forest). Optimized for clear map reading; not an authoritative forestry inventory.",
    defaultVisible: false,
    color: "#4f7f50",
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: TN_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
      "USGS The National Map cached shaded relief, derived from 3DEP at large and medium scales — useful for reading eastern Tennessee's Appalachian terrain.",
    defaultVisible: false,
    color: "#8d8a82",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: TN_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: TN_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. TVA's nuclear fleet (Browns Ferry, Watts Bar, Sequoyah) and extensive hydroelectric system anchor Tennessee's generation mix. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: TN_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported Tennessee data center campuses/projects. Not exhaustive.",
    defaultVisible: true,
...
export function getTnLayer(id: string): LayerDefinition | undefined {
  return TN_LAYERS.find((l) => l.id === id);
}

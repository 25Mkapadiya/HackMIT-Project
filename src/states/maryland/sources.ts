...
/**
 * Canonical source metadata for Maryland. Mirrors src/states/westvirginia/sources.ts:
 * MDE requires water appropriation/use permits and monthly e-reporting for
 * certain permittees, and hosts several ArcGIS REST services (water-quality
 * assessment units, use classes), but no public point-level GIS layer of
 * appropriation permits was found, and no road functional-classification GIS
...
export const MD_SOURCES = {
  curatedDataCenters: {
    id: "curated-md-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Maryland)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Maryland data center campuses/projects. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

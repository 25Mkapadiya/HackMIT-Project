...
import { LA_SOURCES } from "./sources";

/**
 * Full layer registry for Louisiana — mirrors src/states/arkansas/layers.ts.
...
export const LA_LAYERS: LayerDefinition[] = [
  ...
  },
  {
    ...
    source: LA_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: LA_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: LA_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Mississippi, Atchafalaya, Red, Sabine, and Calcasieu River systems.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: LA_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
    description: "USGS National Hydrography Dataset waterbody polygons (small-scale), including coastal Louisiana's extensive wetland/waterbody mosaic.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: LA_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: LA_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: LA_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities — a proxy for interconnection density, not a survey of long-haul fiber routes or Gulf Coast submarine-cable landing infrastructure.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: LA_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. Flood/coastal risk screening is significantly more important in Louisiana than in most inland states — check the Mississippi River corridor, coastal parishes, and the Atchafalaya Basin closely.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: LA_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
      "Visual forest/wood land-cover polygons from the CARTO basemap's OpenStreetMap-derived landcover layer (e.g. Kisatchie National Forest). Optimized for clear map reading; not an authoritative forestry inventory.",
    defaultVisible: false,
    color: "#4f7f50",
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: LA_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
      "USGS The National Map cached shaded relief, derived from 3DEP at large and medium scales. Rendered as a subtle flat overlay for terrain context — most of coastal Louisiana is near sea level, so flood-zone data is a more useful risk signal here than relief.",
    defaultVisible: false,
    color: "#8d8a82",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: LA_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: LA_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. Louisiana has one of the largest concentrations of dispatchable natural-gas generation in the US. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: LA_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported Louisiana data center campuses/projects. Not exhaustive.",
    defaultVisible: true,
...
export function getLaLayer(id: string): LayerDefinition | undefined {
  return LA_LAYERS.find((l) => l.id === id);
}

...
/**
 * Canonical source metadata for Rhode Island. RIDEM administers water
 * withdrawal programs, but no public point-level GIS layer of withdrawal
 * permits was found, so water rights correctly degrade to UNKNOWN in
 * src/lib/gis/stateGis.ts rather than guessing.
 */
export const RI_SOURCES = {
  curatedDataCenters: {
    id: "curated-ri-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Rhode Island)",
    url: "",

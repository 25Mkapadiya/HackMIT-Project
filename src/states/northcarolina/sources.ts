...
/**
 * Canonical source metadata for North Carolina. Mirrors src/states/southcarolina/sources.ts:
 * NCDEQ's Division of Water Resources administers a withdrawal/transfer
 * registration program (threshold ≥100,000 gal/day for most non-agricultural
 * uses) but publishes no public point-level GIS layer we could find, and no
 * road functional-classification GIS layer was found either — both correctly
 * degrade to UNKNOWN in src/lib/gis/stateGis.ts rather than guessing.
 */
export const NC_SOURCES = {
  curatedDataCenters: {
    id: "curated-nc-datacenters",
    name: "Curated Known/Announced Data Center Campuses (North Carolina)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported North Carolina data center campuses/projects. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

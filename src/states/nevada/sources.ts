...
/**
 * Canonical source metadata for Nevada. Mirrors src/states/virginia/sources.ts:
 ...
 */
export const NV_SOURCES = {
  curatedDataCenters: {
    id: "curated-nv-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Nevada)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "No facility points are shown: the research names Reno-Sparks, the Tahoe-Reno Industrial Center, Las Vegas and Henderson as markets but provides no verified facility coordinates.",
  },

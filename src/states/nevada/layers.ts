...
import { NV_SOURCES } from "./sources";

/**
 * Full layer registry for Nevada — mirrors src/states/virginia/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const NV_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: NV_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static - see source note). Nevada is a Western Interconnection hub linking California, Arizona, Utah and the Pacific Northwest; NV Energy and WAPA own most high-voltage lines. Line proximity does not establish available MW or substation headroom.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: NV_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
      "HIFLD electric retail service territory boundaries (static 2025-08-21 snapshot). Informational - not an official service determination; confirm the serving utility (NV Energy, Valley Electric Association, Lincoln County Power District, Overton Power District, or a municipal) directly.",
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: NV_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: NV_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Truckee, Carson, Humboldt and Colorado river systems. Proximity does not imply a water right; Nevada's State Engineer administers rights and basin restrictions.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: NV_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: NV_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: NV_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: NV_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities - a proxy for interconnection density (Las Vegas, Reno). Not proof of long-haul or dark-fiber availability.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: NV_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. Truckee and Carson river corridors, the Las Vegas Wash and localized desert flash-flood areas are priority checks.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: NV_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: NV_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
      "USGS The National Map cached shaded relief - terrain context only. Extreme heat, drought and wildfire exposure require separate review.",
    defaultVisible: false,
    color: "#8d8a82",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: NV_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: NV_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA - Nevada's gas, solar, geothermal, battery and hydro fleet. Display as NEARBY GENERATION only; nameplate capacity is not available power. Requires a server-side EIA_API_KEY.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: NV_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "No facility points are shown: the research names Reno-Sparks, the Tahoe-Reno Industrial Center, Las Vegas and Henderson as markets but provides no verified facility coordinates.",
    defaultVisible: true,
...
export function getVaLayer(id: string): LayerDefinition | undefined {
  return NV_LAYERS.find((l) => l.id === id);
}

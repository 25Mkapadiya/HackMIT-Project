...
/**
 * Canonical source metadata for Pennsylvania. PA DEP administers the
 * statewide Water Withdrawal Registration & Reporting Program, but no
 * public point-level GIS layer of individual withdrawal registrations was
 * found, so water rights correctly degrade to UNKNOWN in
 * src/lib/gis/stateGis.ts rather than guessing.
 */
export const PA_SOURCES = {
  curatedDataCenters: {
    id: "curated-pa-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Pennsylvania)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Pennsylvania data center/colocation markets. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

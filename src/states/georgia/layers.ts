...
import { GA_SOURCES } from "./sources";

/**
 * Full layer registry for Georgia — mirrors src/states/florida/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const GA_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: GA_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static — see source note). Georgia is served primarily by Georgia Power, Electric Membership Corporations (EMCs), and municipal systems (including MEAG) — vertically integrated utility territory rather than a competitive RTO market.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: GA_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
      "HIFLD electric retail service territory boundaries (static 2025-08-21 snapshot). Informational — not an official service determination; Georgia's own Territorial Electric Service Act also governs assigned service areas directly.",
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: GA_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: GA_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Chattahoochee, Savannah, Ocmulgee, Oconee, and Flint River systems.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: GA_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: GA_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: GA_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: GA_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities — a proxy for interconnection density. Metro Atlanta is one of the largest hyperscale/colocation markets in North America, so this list is illustrative, not exhaustive.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: GA_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. The Chattahoochee, Savannah, and Flint River basins and coastal Georgia are priority areas to check.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: GA_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
      "Visual forest/wood land-cover polygons from the CARTO basemap's OpenStreetMap-derived landcover layer (e.g. Chattahoochee-Oconee National Forest). Optimized for clear map reading; not an authoritative forestry inventory.",
    defaultVisible: false,
    color: "#4f7f50",
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: GA_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: GA_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: GA_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. Plant Vogtle and Plant Hatch nuclear stations plus an extensive natural-gas and growing solar fleet anchor Georgia's generation mix. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: GA_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported Georgia data center campuses/projects. Not exhaustive.",
    defaultVisible: true,
...
export function getGaLayer(id: string): LayerDefinition | undefined {
  return GA_LAYERS.find((l) => l.id === id);
}

...
/**
 * Full layer registry for Minnesota — mirrors src/states/delaware/layers.ts.
...
export const MN_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static — see source note). Minnesota is primarily within the Midcontinent Independent System Operator (MISO) region.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: MN_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: MN_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: MN_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Mississippi River headwaters and Minnesota River.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: MN_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
    description: "USGS National Hydrography Dataset waterbody polygons (small-scale) — Minnesota's roughly 11,800 lakes plus the Lake Superior shoreline.",
    defaultVisible: true,
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    confidence: "fact",
    description: "PeeringDB-listed carrier hotels and colocation facilities — a proxy for interconnection density in the Twin Cities telecom ecosystem.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: MN_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. Minnesota's generation mix includes wind, natural gas, nuclear, solar, and coal. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported Minnesota data center/colocation markets. Not exhaustive.",
    defaultVisible: true,

...
/**
 * Canonical source metadata for Mississippi. Mirrors src/states/louisiana/sources.ts:
 * MDEQ's Water Availability and Use program administers withdrawal permits but
 * publishes no public point-level GIS layer we could find, and no road
...
export const MS_SOURCES = {
  curatedDataCenters: {
    id: "curated-ms-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Mississippi)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Mississippi data center campuses/projects. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

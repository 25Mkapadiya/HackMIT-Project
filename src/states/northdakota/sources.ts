...
/**
 * Canonical source metadata for North Dakota. The North Dakota State Water
 * Commission / Office of the State Engineer administers water-right
 * permitting, but no confirmed public point-level GIS layer of individual
 * water rights was found, so water rights correctly degrade to UNKNOWN in
 * src/lib/gis/stateGis.ts rather than guessing.
 */
export const ND_SOURCES = {
  curatedDataCenters: {
    id: "curated-nd-datacenters",
    name: "Curated Known/Announced Data Center Campuses (North Dakota)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported North Dakota data center/colocation markets. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

...
/**
 * Canonical source metadata for Indiana. Indiana DNR tracks Significant
 * Water Withdrawal Facilities (SWWF) above 100,000 gallons/day, but no
 * confirmed public point-level GIS layer of individual SWWF locations was
 * found, so water rights correctly degrade to UNKNOWN in
 * src/lib/gis/stateGis.ts rather than guessing.
 */
export const IN_SOURCES = {
  curatedDataCenters: {
    id: "curated-in-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Indiana)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Indiana data center/colocation markets. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

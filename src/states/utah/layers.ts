...
import { UT_SOURCES } from "./sources";

/**
 * Full layer registry for Utah — mirrors src/states/virginia/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const UT_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: UT_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static - see source note). Utah is a Western Interconnection corridor served chiefly by Rocky Mountain Power (PacifiCorp) with WAPA lines and municipal/cooperative systems. Line proximity does not establish available MW or substation headroom.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: UT_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
      "HIFLD electric retail service territory boundaries (static 2025-08-21 snapshot). Informational - not an official service determination; Utah's Division of Public Utilities and UGRC publish state service-area mapping (not integrated here) - confirm the serving utility (Rocky Mountain Power, a municipal, or a cooperative) directly.",
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: UT_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: UT_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Jordan, Bear and Colorado river systems. Proximity does not imply a water right; the Division of Water Rights administers appropriation.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: UT_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: UT_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: UT_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: UT_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities - a proxy for interconnection density (Salt Lake). Not proof of long-haul or dark-fiber availability.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: UT_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. Wasatch Front waterways, the Jordan River corridor, the Utah Lake basin and flash-flood-prone desert areas are priority checks.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: UT_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: UT_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
      "USGS The National Map cached shaded relief - terrain context only. Wasatch Fault seismic risk and wildfire exposure require separate review.",
    defaultVisible: false,
    color: "#8d8a82",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: UT_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: UT_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA - Utah's gas, coal, solar, hydro and geothermal fleet. Display as NEARBY GENERATION only; nameplate capacity is not available power. Requires a server-side EIA_API_KEY.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: UT_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "No facility points are shown: the research names the Salt Lake Valley, West Jordan, Eagle Mountain, Saratoga Springs, Lehi and the Provo corridor as markets but provides no verified facility coordinates.",
    defaultVisible: true,
...
export function getVaLayer(id: string): LayerDefinition | undefined {
  return UT_LAYERS.find((l) => l.id === id);
}

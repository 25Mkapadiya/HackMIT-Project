...
/**
 * Canonical source metadata for New York. NY DEC administers water
 * withdrawal permitting, but no public point-level GIS layer of permits was
 * found, so water rights correctly degrade to UNKNOWN in
 * src/lib/gis/stateGis.ts rather than guessing.
 */
export const NY_SOURCES = {
  curatedDataCenters: {
    id: "curated-ny-datacenters",
    name: "Curated Known/Announced Data Center Campuses (New York)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported New York data center/colocation markets. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

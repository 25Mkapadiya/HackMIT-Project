...
/**
 * Canonical source metadata for Vermont. Act 135 (2022) requires registration
 * and annual reporting for qualifying surface-water withdrawals, but no
 * public point-level GIS layer of registered withdrawals was found, so water
 * rights correctly degrade to UNKNOWN in src/lib/gis/stateGis.ts rather than
 * guessing.
 */
export const VT_SOURCES = {
  curatedDataCenters: {
    id: "curated-vt-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Vermont)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Vermont data center/colocation activity. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

...
/**
 * Canonical source metadata for Arizona. The Arizona Department of Water
 * Resources (ADWR) regulates groundwater and surface water, including
 * Active Management Areas, but no confirmed public point-level GIS layer
 * of individual water rights was found, so water rights correctly degrade
 * to UNKNOWN in src/lib/gis/stateGis.ts rather than guessing.
 */
export const AZ_SOURCES = {
  curatedDataCenters: {
    id: "curated-az-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Arizona)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Arizona data center campuses, concentrated in the Phoenix metro area. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

...
/**
 * Canonical source metadata for Alaska. Mirrors src/states/virginia/sources.ts:
 ...
 */
export const AK_SOURCES = {
  curatedDataCenters: {
    id: "curated-ak-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Alaska)",
    url: "",

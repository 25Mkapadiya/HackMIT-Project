...
import { SC_SOURCES } from "./sources";

/**
 * Full layer registry for South Carolina — mirrors src/states/georgia/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const SC_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: SC_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static — see source note). South Carolina is served by Dominion Energy South Carolina, Duke Energy Carolinas/Progress, Santee Cooper, and cooperatives — not fully organized under a traditional RTO.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: SC_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: SC_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: SC_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Savannah, Congaree, Pee Dee, Santee, and Broad River systems.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: SC_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: SC_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: SC_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: SC_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities — a proxy for interconnection density, not a survey of long-haul fiber routes through Charlotte, Atlanta, or Charleston/Savannah corridors.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: SC_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. Coastal South Carolina, the Pee Dee Basin, the Santee Basin, and the Savannah River corridor are priority areas to check.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: SC_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
      "Visual forest/wood land-cover polygons from the CARTO basemap's OpenStreetMap-derived landcover layer (e.g. Francis Marion and Sumter National Forests). Optimized for clear map reading; not an authoritative forestry inventory.",
    defaultVisible: false,
    color: "#4f7f50",
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: SC_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: SC_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: SC_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. Oconee, Catawba, and V.C. Summer nuclear stations plus large utility-scale solar anchor South Carolina's generation mix. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: SC_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported South Carolina data center campuses/projects. Not exhaustive.",
    defaultVisible: true,
...
export function getScLayer(id: string): LayerDefinition | undefined {
  return SC_LAYERS.find((l) => l.id === id);
}

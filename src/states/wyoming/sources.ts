...
/**
 * Canonical source metadata for Wyoming. Mirrors src/states/virginia/sources.ts:
...
export const WY_SOURCES = {
  curatedDataCenters: {
    id: "curated-wy-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Wyoming)",
    url: "",

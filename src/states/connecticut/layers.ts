...
import { CT_SOURCES } from "./sources";

/**
 * Full layer registry for Connecticut — mirrors src/states/delaware/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const CT_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: CT_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static — see source note). Connecticut includes roughly 475 miles of 345 kV transmission within the ISO-New England market.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: CT_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: CT_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: CT_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Connecticut, Housatonic, and Thames River systems.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: CT_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
    description: "USGS National Hydrography Dataset waterbody polygons (small-scale), including Long Island Sound.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: CT_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: CT_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: CT_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities — a proxy for interconnection density. Connecticut sits between the New York and Boston fiber markets.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: CT_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. The Connecticut River corridor and coastal Long Island Sound communities are priority areas to check.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: CT_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: CT_SOURCES.usgsShadedRelief,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: CT_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: CT_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. Connecticut's generation mix includes natural gas, nuclear (Millstone), solar, and hydroelectric. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: CT_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported Connecticut data center/colocation clusters. Not exhaustive.",
    defaultVisible: true,
...
export function getCtLayer(id: string): LayerDefinition | undefined {
  return CT_LAYERS.find((l) => l.id === id);
}

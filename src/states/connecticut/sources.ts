...
/**
 * Canonical source metadata for Connecticut. CT DEEP administers water
 * withdrawals through its Water Diversion Program (permits and general
 * permits), but no public point-level GIS layer of diversion permits was
 * found, so water rights correctly degrade to UNKNOWN in
 * src/lib/gis/stateGis.ts rather than guessing.
 */
export const CT_SOURCES = {
  curatedDataCenters: {
    id: "curated-ct-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Connecticut)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Connecticut data center/colocation clusters. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

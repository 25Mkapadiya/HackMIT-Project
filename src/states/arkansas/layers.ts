...
import { AR_SOURCES } from "./sources";

/**
 * Full layer registry for Arkansas — mirrors src/states/oklahoma/layers.ts.
 * No "water-diversions" or "state-highways" layers: no verified public GIS
 * dataset was found for Arkansas water-rights permits or road functional
 * classification (see sources.ts and stateGis.ts for the resulting UNKNOWN
 * handling), so they're correctly omitted rather than faked.
 */
export const AR_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: AR_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static — see source note). Arkansas is served primarily by Entergy Arkansas, SWEPCO, and electric cooperatives within the Southwest Power Pool (SPP).",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: AR_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: AR_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: AR_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Arkansas, Mississippi, and White River systems.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: AR_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: AR_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: AR_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: AR_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. Mississippi River and Arkansas River corridors and the Delta region are priority areas to check.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: AR_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
      "Visual forest/wood land-cover polygons from the CARTO basemap's OpenStreetMap-derived landcover layer (e.g. Ozark-St. Francis and Ouachita National Forests). Optimized for clear map reading; not an authoritative forestry inventory.",
    defaultVisible: false,
    color: "#4f7f50",
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: AR_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: AR_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: AR_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. Arkansas Nuclear One and major Arkansas River hydroelectric resources anchor the state's generation mix. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: AR_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported Arkansas data center campuses/projects. Not exhaustive.",
    defaultVisible: true,
...
export function getArLayer(id: string): LayerDefinition | undefined {
  return AR_LAYERS.find((l) => l.id === id);
}

...
/**
 * Canonical source metadata for Kansas. The Kansas Division of Water
 * Resources administers water-right permitting under a prior-appropriation
 * system, but no confirmed public point-level GIS layer of individual
 * water rights was found, so water rights correctly degrade to UNKNOWN in
 * src/lib/gis/stateGis.ts rather than guessing.
 */
export const KS_SOURCES = {
  curatedDataCenters: {
    id: "curated-ks-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Kansas)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Kansas data center/colocation markets. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

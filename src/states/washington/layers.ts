...
export const WA_LAYERS: LayerDefinition[] = [
...

  {
    ...
    category: "environment",
    geometryType: "raster",
    source: WA_SOURCES.usfsTreeCanopy,
    confidence: "fact",
    description:
      "USDA Forest Service NLCD tree-canopy raster. Uses continuous canopy coverage for a softer, Google-Maps-style green landscape treatment instead of administrative forest polygons.",
    defaultVisible: false,
    color: "#4f7f50",
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: WA_SOURCES.usgs3depTerrain,
    confidence: "fact",
    description:
      "USGS 3DEP bare-earth elevation rendered as subtle multidirectional shaded relief. No 3D extrusion; the layer is intended to read like a clean reference-map terrain treatment.",
    defaultVisible: false,
    color: "#8d8a82",

...
export const WA_SOURCES = {
  ...
  usfsTreeCanopy: {
    id: "usfs-tree-canopy",
    name: "USDA Forest Service — NLCD Tree Canopy Cover",
    url: "https://tiles.arcgis.com/tiles/9lDFdeC4JIBgML6L/arcgis/rest/services/Tree_Canopy_Cover/MapServer",
    license: "U.S. Government public data",
    refreshFrequency: "Forest Service / NLCD cartographic tree-canopy product",
    methodology: "Raster percent-tree-canopy product designed for cartographic display. Used as a visual forest-cover layer rather than an ownership boundary.",
  },
  usgs3depTerrain: {
    ...
    license: "Public domain (USGS)",
    refreshFrequency: "USGS 3DEP dynamic elevation service",
    methodology: "U.S. bare-earth elevation rendered server-side with a multidirectional hillshade. Displayed as subtle relief only; no artificial 3D extrusion.",
  },
  wsdotHighways: {

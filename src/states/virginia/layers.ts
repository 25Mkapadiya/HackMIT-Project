...
import { VA_SOURCES } from "./sources";

/**
 * Full layer registry for Virginia — mirrors src/states/northcarolina/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const VA_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: VA_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static — see source note). Virginia is served primarily by Dominion Energy Virginia and Appalachian Power, largely within PJM Interconnection — one of the most heavily developed transmission networks in the eastern US due to Northern Virginia's data center growth.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: VA_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
      "HIFLD electric retail service territory boundaries (static 2025-08-21 snapshot). Informational — not an official service determination; Virginia's State Corporation Commission (SCC) also maintains territory maps directly.",
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: VA_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: VA_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Potomac, James, Rappahannock, York, and Roanoke River systems.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: VA_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: VA_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: VA_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: VA_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities — a proxy for interconnection density. Northern Virginia has arguably the highest concentration of fiber and internet-exchange infrastructure in the world, so this list is illustrative, not exhaustive.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: VA_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. Tidewater/coastal Virginia, Potomac floodplains, and the James River corridor are priority areas to check.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: VA_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: VA_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
      "USGS The National Map cached shaded relief, derived from 3DEP at large and medium scales — useful for reading the Blue Ridge/Shenandoah terrain in western Virginia.",
    defaultVisible: false,
    color: "#8d8a82",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: VA_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: VA_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA. North Anna and Surry nuclear stations plus an extensive natural-gas fleet anchor Virginia's generation mix. Requires a server-side EIA_API_KEY — shown as unavailable until configured.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: VA_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "Hand-curated, illustrative list of publicly reported Virginia data center campuses/projects. Not exhaustive — Northern Virginia is the world's largest data center market.",
    defaultVisible: true,
...
export function getVaLayer(id: string): LayerDefinition | undefined {
  return VA_LAYERS.find((l) => l.id === id);
}

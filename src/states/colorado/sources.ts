...
/**
 * Canonical source metadata for Colorado. Mirrors src/states/virginia/sources.ts:
...
export const CO_SOURCES = {
  curatedDataCenters: {
    id: "curated-co-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Colorado)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "No facility points are shown: the research names Denver, Aurora, Colorado Springs, Fort Collins and the Front Range as markets but provides no verified facility coordinates.",
  },

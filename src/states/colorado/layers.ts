...
import { CO_SOURCES } from "./sources";

/**
 * Full layer registry for Colorado — mirrors src/states/virginia/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const CO_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: CO_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static - see source note). Colorado is a Western Interconnection crossroads served chiefly by Xcel Energy (Public Service Company of Colorado), Black Hills Energy, Tri-State and WAPA. Line proximity does not establish available MW or substation headroom.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: CO_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
      "HIFLD electric retail service territory boundaries (static 2025-08-21 snapshot). Informational - not an official service determination; Colorado publishes statewide utility territory data (not integrated here) - confirm the serving utility (Xcel Energy, Black Hills, a municipal, or a cooperative) directly.",
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: CO_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: CO_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Colorado, South Platte, Arkansas, Rio Grande and Gunnison river systems. Proximity does not imply a water right; Colorado water rights are adjudicated through water courts.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: CO_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: CO_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: CO_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: CO_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities - a proxy for interconnection density (Denver). Not proof of long-haul or dark-fiber availability.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: CO_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. The South Platte and Arkansas corridors, Front Range waterways and mountain canyons are priority checks.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: CO_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: CO_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
      "USGS The National Map cached shaded relief - terrain context only. Wildfire, hail and Front Range wind exposure require separate review.",
    defaultVisible: false,
    color: "#8d8a82",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: CO_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: CO_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA - Colorado's gas, wind, solar, coal and hydro fleet. Display as NEARBY GENERATION only; nameplate capacity is not available power. Requires a server-side EIA_API_KEY.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: CO_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "No facility points are shown: the research names Denver, Aurora, Colorado Springs, Fort Collins and the Front Range as markets but provides no verified facility coordinates.",
    defaultVisible: true,
...
export function getVaLayer(id: string): LayerDefinition | undefined {
  return CO_LAYERS.find((l) => l.id === id);
}

...
/**
 * Canonical source metadata for Nebraska. The Nebraska Department of
 * Natural Resources and local Natural Resources Districts administer water
 * appropriation and groundwater management, but no confirmed public
 * point-level GIS layer of individual water rights was found, so water
 * rights correctly degrade to UNKNOWN in src/lib/gis/stateGis.ts rather
 * than guessing.
 */
export const NE_SOURCES = {
  curatedDataCenters: {
    id: "curated-ne-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Nebraska)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Nebraska data center/colocation markets. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },

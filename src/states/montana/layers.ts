...
import { MT_SOURCES } from "./sources";

/**
 * Full layer registry for Montana — mirrors src/states/virginia/layers.ts.
 * No "water-diversions" or "state-highways" layers — see sources.ts.
 */
export const MT_LAYERS: LayerDefinition[] = [
  // ---------------------------------------------------------------- POWER
  {
    ...
    category: "power",
    geometryType: "line",
    source: MT_SOURCES.hifldTransmission,
    confidence: "fact",
    description:
      "HIFLD transmission line geometry and voltage class (nationwide extract, static - see source note). Montana is a Western Interconnection corridor linking the Pacific Northwest, Rockies and Upper Plains; NorthWestern Energy is the main transmission owner alongside BPA and cooperatives. Line proximity does not establish available MW or substation headroom.",
    defaultVisible: true,
  ...
  },
  {
    ...
    source: MT_SOURCES.hifldUtilityTerritories,
    confidence: "proxy",
    description:
      "HIFLD electric retail service territory boundaries (static 2025-08-21 snapshot). Informational - not an official service determination; Montana has extensive rural cooperative territory - confirm the serving utility (NorthWestern Energy, MDU, a cooperative, or municipal) directly; the Montana PSC and State Library publish territory resources.",
  ...
  },
  {
    ...
    category: "power",
    geometryType: "point",
    source: MT_SOURCES.hifldSubstations,
    confidence: "fact",
    description:
  ...
  // ---------------------------------------------------------------- WATER
  {
    ...
    category: "water",
    geometryType: "line",
    source: MT_SOURCES.usgsNhdFlowline,
    confidence: "fact",
    description: "USGS National Hydrography Dataset flowlines (small-scale), including the Missouri, Yellowstone, Clark Fork, Flathead and Milk river systems. Proximity does not imply a water right (recorded through DNRC).",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: MT_SOURCES.usgsNhdWaterbody,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "point",
    source: MT_SOURCES.usgsNwisGauges,
    confidence: "fact",
  ...
  },
  {
    ...
    category: "water",
    geometryType: "polygon",
    source: MT_SOURCES.usDroughtMonitor,
    confidence: "fact",
  ...
  // --------------------------------------------------------- CONNECTIVITY
  {
    ...
    geometryType: "point",
    source: MT_SOURCES.peeringDb,
    confidence: "fact",
    description:
      "PeeringDB-listed carrier hotels and colocation facilities - sparse in Montana; a proxy only, not proof of long-haul or dark-fiber availability.",
    defaultVisible: true,
  ...
  // ----------------------------------------------------------- ENVIRONMENT
  {
    ...
    geometryType: "polygon",
    source: MT_SOURCES.femaNfhl,
    confidence: "fact",
    description: "Effective FEMA National Flood Hazard Layer zones, where mapped. Yellowstone and Missouri basins, the Flathead Valley and major stream corridors are priority checks.",
    defaultVisible: false,
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: MT_SOURCES.cartoForestCover,
    confidence: "proxy",
    description:
  ...
  },
  {
    ...
    category: "environment",
    geometryType: "raster",
    source: MT_SOURCES.usgsShadedRelief,
    confidence: "fact",
    description:
      "USGS The National Map cached shaded relief - terrain context only. Wildfire and severe-winter exposure require separate review.",
    defaultVisible: false,
    color: "#8d8a82",
  ...
  },
  {
    ...
    category: "community",
    geometryType: "polygon",
    source: MT_SOURCES.censusCountyDensity,
  ...
  // ----------------------------------------------------- EXISTING INFRA
  {
    ...
    geometryType: "point",
    source: MT_SOURCES.eia,
    confidence: "unknown",
    description:
      "Nearby generating facilities from EIA - Montana's coal, hydro, wind, gas and solar fleet. Display as NEARBY GENERATION only; nameplate capacity is not available power. Requires a server-side EIA_API_KEY.",
    defaultVisible: true,
  ...
  },
  {
    ...
    category: "existing_infrastructure",
    geometryType: "point",
    source: MT_SOURCES.curatedDataCenters,
    confidence: "proxy",
    description: "No facility points are shown: the research names Butte, Billings, Great Falls and Missoula as markets but provides no verified facility coordinates.",
    defaultVisible: true,
...
export function getVaLayer(id: string): LayerDefinition | undefined {
  return MT_LAYERS.find((l) => l.id === id);
}

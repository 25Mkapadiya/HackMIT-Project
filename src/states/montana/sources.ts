...
/**
 * Canonical source metadata for Montana. Mirrors src/states/virginia/sources.ts:
 ...
 */
export const MT_SOURCES = {
  curatedDataCenters: {
    id: "curated-mt-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Montana)",
    url: "",

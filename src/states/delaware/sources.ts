...
/**
 * Canonical source metadata for Delaware. Mirrors src/states/maryland/sources.ts:
 * DNREC regulates water withdrawals/appropriations through environmental
 * permitting, but no public point-level GIS layer of permits was found, and
 * no road functional-classification GIS layer was found either — both
 * correctly degrade to UNKNOWN in src/lib/gis/stateGis.ts rather than
 * guessing.
 */
export const DE_SOURCES = {
  curatedDataCenters: {
    id: "curated-de-datacenters",
    name: "Curated Known/Announced Data Center Campuses (Delaware)",
    url: "",
    license: "Compiled from public reporting; not an authoritative registry",
    refreshFrequency: "Manually maintained",
    methodology: "Hand-curated illustrative list of publicly reported Delaware data center campuses/projects. NOT exhaustive and NOT independently verified against parcel/operator records.",
  },
